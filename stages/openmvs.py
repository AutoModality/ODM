...
class ODMOpenMVSStage(types.ODM_Stage):
    def process(self, args, outputs):
        ...
        if not io.file_exists(tree.openmvs_model) or self.rerun():
            ...
            subres_levels = 2 # The number of lower resolutions to process before estimating output resolution depthmap, 0=disabled
            ...
            sharp = args.pc_filter > 0 or args.pc_geometric
